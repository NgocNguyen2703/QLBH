...
namespace BTLLTQL.Controllers
{
    ...
    public class LoaiDichVusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDLoaiDichVu,TenLoaiDichVu")] LoaiDichVu loaiDichVu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDLoaiDichVu,TenLoaiDichVu")] LoaiDichVu loaiDichVu)
        {
            if (ModelState.IsValid)
            {
